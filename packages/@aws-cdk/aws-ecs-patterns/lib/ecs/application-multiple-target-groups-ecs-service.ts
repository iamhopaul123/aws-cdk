...
import { ApplicationMultipleTargetGroupsServiceBase, ApplicationMultipleTargetGroupsServiceBaseProps,
  ApplicationTargetProps } from '../base/application-multiple-target-groups-service-base';
